(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Verizon Communications Inc., LEI
  2S72QS2UO2OESLG6Y829) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Verizon Communications Inc."
   :website    "https://www.verizon.com"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by Verizon Communications Inc., a telecommunications company, for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.verizon.com/about/terms-conditions/terms-of-use"
